...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",1)~ THEN BEGIN BLK201
    SAY @1502
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",1)~ THEN BEGIN BLK202
    SAY @1504
    IF~~THEN REPLY @1505
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK301
    SAY @1508
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK302
    SAY @1511
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK303
    SAY @1513
    IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK304
    SAY @1515
    IF~~THEN REPLY @1505
      DO ~SetGlobal("ys_CeinwenSpellhold","GLOBAL",0)
          SetGlobal("dai_TalkedToCeinwen","GLOBAL",5)
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK305
    SAY @1516
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK306
    SAY @1518
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK307
    SAY @1520
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK308
    SAY @1522
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK309
    SAY @1525
    IF~~THEN REPLY @1526
      DO ~SetGlobal("ys_CeinwenSpellhold","GLOBAL",0)
          SetGlobal("dai_TalkedToCeinwen","GLOBAL",5)
...
//---------------------------------------------------------
IF ~Global("ys_CeinwenSpellhold","GLOBAL",1)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK310
    SAY @1527
    IF~~THEN REPLY @1528
      DO ~SetGlobal("ys_CeinwenSpellhold","GLOBAL",0)
          SetGlobal("dai_TalkedToCeinwen","GLOBAL",5)
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)
    Global("ys_RudeToCeinwen","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @1533
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)
    Global("ys_RudeToCeinwen","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @1535
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)
    Global("ys_RudeToCeinwen","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @1537
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)
    Global("ys_RudeToCeinwen","GLOBAL",0)~ THEN BEGIN BLK4
	SAY @1540
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)
    Global("ys_RudeToCeinwen","GLOBAL",0)~ THEN BEGIN BLK5
	SAY @1542
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)
    Global("ys_RudeToCeinwen","GLOBAL",0)~ THEN BEGIN BLK6
	SAY @1544
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)~ THEN BEGIN BLK9
	 SAY @1548
	 IF~~THEN REPLY @1549 GOTO BLK10
END

//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)~ THEN BEGIN BLK10
	 SAY @1550
	 IF~~THEN REPLY @1551 GOTO BLK11
END

//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)~ THEN BEGIN BLK11
	 SAY @1552
	 IF~~THEN REPLY @1553 GOTO BLK12
END

//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)~ THEN BEGIN BLK12
	 SAY @1554
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)~ THEN BEGIN BLK13
    SAY @1556
    IF~~THEN
...
IF ~Global("dai_TalkedToCeinwen","GLOBAL",0)~ THEN BEGIN BLK14
    SAY @1558
    IF~~THEN
      DO ~SetGlobal("dai_TalkedToCeinwen","GLOBAL",1)
          SetGlobalTimer("ys_CeinwenTimer","GLOBAL",ONE_DAY)~
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",4)~ THEN BEGIN BLK101
	SAY @1566
	IF~~THEN REPLY @1567 GOTO BLK102
END

//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",4)~ THEN BEGIN BLK102
	SAY @1568
	IF~~THEN REPLY @1569 GOTO BLK103
END

//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",4)~ THEN BEGIN BLK103
	SAY @1570
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",4)~ THEN BEGIN BLK105
	SAY @1571
	IF~~THEN REPLY @1572 GOTO BLK106
END

//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",4)~ THEN BEGIN BLK106
	SAY @1573
	IF~~THEN
    DO ~SetGlobal("dai_TalkedToCeinwen","GLOBAL",5)
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",1)~ THEN BEGIN BLK401
	SAY @1576
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK402
	SAY @1578
	IF~~THEN REPLY @1579
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK403
	SAY @1580
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK404
	SAY @1582
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK405
	SAY @1584
  =@1585
  =@1586
	=@1587
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK406
	SAY @1590
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK407
	SAY @1592
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK408
	SAY @1594
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK409
	SAY @1596
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",5)
    Global("ys_CeinwenRot","GLOBAL",0)~ THEN BEGIN BLK410
	SAY @1598
	IF~~THEN REPLY @1599
...
IF ~Global("dai_TalkedToCeinwen","GLOBAL",6)
  Global("ys_CeinwenRot","GLOBAL",0)
  Global("ys_VampChildIsDead","GLOBAL",1)~ THEN BEGIN BLK511
	SAY @1604
	IF~~THEN
...
IF ~Global("dai_TalkedToCeinwen","GLOBAL",7)
    GlobalTimerExpired("ys_CeinwenTimer","GLOBAL")
    Global("ys_VampChildIsDead","GLOBAL",1)~ THEN BEGIN BLK601
  SAY@1607
  IF~~THEN REPLY@1608
...
IF ~Global("dai_TalkedToCeinwen","GLOBAL",7)
    GlobalTimerExpired("ys_CeinwenTimer","GLOBAL")
    Global("ys_VampChildIsDead","GLOBAL",1)~ THEN BEGIN BLK602
  SAY@1609
  IF~~THEN
    DO ~SetGlobal("dai_TalkedToCeinwen","GLOBAL",8)
			  GiveItemCreate("yspotn01",Player1,0,0,0)
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",8)
    PartyHasItem("ysghoul1")~THEN BEGIN BLK701
  SAY@1614
  IF~~THEN REPLY@1615
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",8)
    PartyHasItem("ysghoul1")~THEN BEGIN BLK702
  SAY@1616
...
//---------------------------------------------------------
IF ~Global("dai_TalkedToCeinwen","GLOBAL",8)
    PartyHasItem("ysghoul1")~THEN BEGIN BLK703
  SAY@1618
  IF~~THEN REPLY@1619

...
//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",0)~ THEN BEGIN 0
	SAY @2602
	IF~~THEN REPLY @2603 GOTO 1000
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",0)~ THEN BEGIN 1000
	SAY @2604
	IF~~THEN REPLY @2605 GOTO 1
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",0)~ THEN BEGIN 1
	SAY @2606
	IF~~THEN REPLY @2607 GOTO 2
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",0)~ THEN BEGIN 2
	SAY @2608
	IF~~THEN REPLY @2609 GOTO 3
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",0)~ THEN BEGIN 3
	SAY @2610
	IF~~THEN REPLY @2611 GOTO 4
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",0)~ THEN BEGIN 4
	SAY @2612
  IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",1)
	 Global("ys_LughDead","GLOBAL",1)~ THEN BEGIN 15
	SAY @2617
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToOengus","GLOBAL",1)
		Global("ys_LughOkay","GLOBAL",1)~ THEN BEGIN 16
	SAY @2618
	IF~~THEN
  	DO~SetGlobal("ys_TalkedToOengus","GLOBAL",2)~
	EXIT

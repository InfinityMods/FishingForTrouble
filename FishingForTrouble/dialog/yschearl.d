...
//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @2203
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @2206
	IF~~THEN REPLY @2207 GOTO BLK3
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @2208
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK4
	SAY @2211
	IF~~THEN REPLY @2212 GOTO BLK5
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK5
	SAY @2213
	IF~~THEN REPLY @2214 GOTO BLK6
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK6
	SAY @2215
	IF~~THEN REPLY @2216 GOTO BLK7
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK7
	SAY @2217
	IF~~THEN REPLY @2218 GOTO BLK8
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK8
	SAY @2219
	IF~~THEN REPLY @2220 GOTO BLK20
	IF~~THEN REPLY @2221GOTO BLK12
END


//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK10
	SAY @2219
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK11
	SAY @2223
	IF~~THEN REPLY @2216 GOTO BLK20
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK12
	SAY @2224
	IF~~THEN DO~
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToWultheof","GLOBAL",0)~ THEN BEGIN BLK20
	SAY @2225

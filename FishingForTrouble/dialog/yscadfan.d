...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 1
	SAY @4395
	IF~~THEN REPLY @4396 GOTO 2
END

//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 2
	SAY @4397
	IF~~THEN REPLY @4398
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 3
	SAY @4399
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 30
	SAY @4402
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 4
	SAY @4405
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 5
	SAY @4408
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 6
	SAY @4410
	IF~~THEN REPLY @4409 GOTO 7
	IF~~THEN REPLY @4401
	 DO~SetGlobal("ysTalkedToCadfan","GLOBAL",1)~
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 65
	SAY @4411
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 7
	SAY @4413
	=@4411
	IF~~THEN REPLY @4412 GOTO 8
	IF~~THEN REPLY @4401
...
//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 8
	SAY @4414
	IF~~THEN REPLY @4415 GOTO 9
END

//---------------------------------------------------------
IF ~Global("ysTalkedToCadfan","GLOBAL",0)~ THEN BEGIN 9
	SAY @4416
	IF~~THEN
	 DO~SetGlobal("ysTalkedToCadfan","GLOBAL",1)~
	EXIT

...
//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK7
	SAY @1180
	IF~~THEN REPLY @1181 GOTO BLK1
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @1182
	IF~~THEN REPLY @1183 GOTO BLK2
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @1184
	IF~~THEN REPLY @1185 GOTO BLK3
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @1186
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK4
	SAY @1188
	IF~~THEN REPLY @1189 GOTO BLK5
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK5
	SAY @1190
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToHHApprentice","GLOBAL",0)~ THEN BEGIN BLK6
	SAY @1192
	IF~~THEN
		DO~SetGlobal("ys_TalkedToHHApprentice","GLOBAL",1)~
	REPLY @1193 EXIT

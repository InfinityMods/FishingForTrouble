...
IF ~Global("dai_TalkedToStoreKeep2","LOCALS",1)
    ...
    SAY @903
    IF~~THEN REPLY @904 GOTO LHBLOCK15
...
IF ~Global("dai_TalkedToStoreKeep2","LOCALS",0)
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK11
    SAY @909
    IF~~THEN REPLY @910 GOTO LHBLOCK100
END

IF ~Global("dai_TalkedToStoreKeep2","LOCALS",0)
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK100
    SAY @911
    IF~~THEN REPLY @912 GOTO LHBLOCK101
END

IF ~Global("dai_TalkedToStoreKeep2","LOCALS",0)
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK101
    SAY @913
    IF~~THEN REPLY @914 GOTO LHBLOCK13
END

IF ~Global("dai_TalkedToStoreKeep2","LOCALS",0)
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK12
    SAY @915
    IF~~THEN REPLY @916 GOTO LHBLOCK14
END

IF ~Global("dai_TalkedToStoreKeep2","LOCALS",0)
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK13
    SAY @917
...
IF ~Global("dai_TalkedToStoreKeep2","LOCALS",0)
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK14
    SAY @919
...
IF ~OR(2)
    ...
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK15
    SAY @920
    IF~~THEN
...
IF ~OR(2)
    ...
    AreaCheck("ys0121")~ THEN BEGIN LHBLOCK16
    SAY @920
    IF~~THEN
...
//Exit
IF ~AreaCheck("ys0121")~ THEN BEGIN LHBLOCK17
    SAY @921
    IF~~THEN
      EXIT
END

...
//---------------------------------------------------------
IF ~GlobalLT("ys_TalkedToAine","GLOBAL",2)~ THEN BEGIN BLK1
	SAY @1856
	IF~~THEN EXIT
END

//---------------------------------------------------------
IF ~GlobalLT("ys_TalkedToAine","GLOBAL",2)~ THEN BEGIN BLK2
	SAY @1857
...
//---------------------------------------------------------
IF ~GlobalLT("ys_TalkedToAine","GLOBAL",2)~ THEN BEGIN BLK3
	SAY @1860
	IF~~THEN REPLY @1861 GOTO BLK4
END

//---------------------------------------------------------
IF ~GlobalLT("ys_TalkedToAine","GLOBAL",2)~ THEN BEGIN BLK4
	SAY @1862
	IF~~THEN
...
//---------------------------------------------------------
IF ~GlobalLT("ys_TalkedToAine","GLOBAL",2)~ THEN BEGIN BLK5
	SAY @1864
	IF~~THEN EXIT
END

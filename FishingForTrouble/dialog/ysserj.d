...
//---------------------------------------------------------
IF ~Global("ys_FreedSarje","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @873
	IF~~THEN REPLY @874 GOTO BLK2
END

//---------------------------------------------------------
IF ~Global("ys_FreedSarje","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @875
...
IF ~Global("ys_FreedSarje","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @877
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_FreedSarje","GLOBAL",2)
		Global("ys_GarrisonFight","GLOBAL",0)~ THEN BEGIN BLK11
	SAY @880
	IF~~THEN REPLY @881
...
//---------------------------------------------------------
IF ~Global("ys_FreedSarje","GLOBAL",2)
		GlobalGT("ys_GarrisonFight","GLOBAL",2)~ THEN BEGIN BLK13
	SAY @883
	IF~~THEN REPLY @884
		DO ~SetGlobal("ys_FreedSarje","GLOBAL",3)
      	ClearAllActions()

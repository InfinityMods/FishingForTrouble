...
//---------------------------------------------------------
IF ~Global("ysTalkedToAdara","GLOBAL",0)
    Global("ysTalkedToAiesha","GLOBAL",3)
    !Global("ysGadilOK","GLOBAL",1)~ THEN BEGIN 1
	SAY @3871
...
IF ~Global("ysTalkedToAdara","GLOBAL",0)
    Global("ysTalkedToAiesha","GLOBAL",3)
    !Global("ysGadilOK","GLOBAL",1)~ THEN BEGIN 2
	SAY @3874
...
//---------------------------------------------------------
IF ~Global("ysTalkedToAdara","GLOBAL",2)
    Global("ysTalkedToAiesha","GLOBAL",3)~ THEN BEGIN 4
	SAY @3878
...
//---------------------------------------------------------
IF ~Global("ysTalkedToAdara","GLOBAL",2)
    Global("ysTalkedToAiesha","GLOBAL",3)~ THEN BEGIN 5
	SAY @3880
	IF~~THEN

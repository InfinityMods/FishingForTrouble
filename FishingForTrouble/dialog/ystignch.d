...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 1
	SAY @3403
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 2
	SAY @3405
	IF~~THEN REPLY @3406 GOTO 4
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 3
	SAY @3407
	IF~~THEN REPLY @3408 GOTO 10
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 4
	SAY @3409
	IF~~THEN REPLY @3410 GOTO 5
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 5
	SAY @3411
	IF~~THEN REPLY @3412 GOTO 6
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 6
	SAY @3413
	IF~~THEN REPLY @3414 GOTO 7
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 7
	SAY @3415
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 8
  SAY@3417
	IF~~THEN REPLY @3418 GOTO 9
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 9
	SAY @3419
	IF~~THEN REPLY @3420
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 10
	SAY @3409
	IF~~THEN REPLY @3421 GOTO 11
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 11
	SAY @3422
	IF~~THEN REPLY @3423 GOTO 12
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTigernach","GLOBAL",0)~ THEN BEGIN 12
	SAY @3424
	IF~~THEN
  DO~GiveItemCreate("ysgldag",Player1,0,0,0)

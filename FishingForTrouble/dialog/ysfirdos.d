...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 10
	SAY @4457
	IF~~THEN REPLY @4458 GOTO 11
END

//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 11
	SAY @4459
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 1
	SAY @4462
	IF~~THEN REPLY @4460 GOTO 2
	IF~~THEN REPLY @4461 GOTO 100
END
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 2
	SAY @4463
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 3
	SAY @4466
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 4
	SAY @4468
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 30
	SAY @4471
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 100
	SAY @4472
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ysTalkedToFirdos","GLOBAL",0)~ THEN BEGIN 300
	SAY @4473
	IF~~THEN
	 DO~SetGlobal("ysTalkedToFirdos","GLOBAL",1)~
	EXIT
END

...
//---------------------------------------------------------
IF ~Global("ysTalkedToRimon","GLOBAL",1)
    Global("ysCreateAkil","GLOBAL",1)~ THEN BEGIN 11
  SAY@4910
...
//---------------------------------------------------------
IF ~Global("ysTalkedToRimon","GLOBAL",1)
    Global("ysCreateAkil","GLOBAL",1)~ THEN BEGIN 12
	SAY @4913
...
//---------------------------------------------------------
IF ~Global("ysTalkedToRimon","GLOBAL",1)
    Global("ysCreateAkil","GLOBAL",1)~ THEN BEGIN 13
	SAY @4915
...
//---------------------------------------------------------
IF ~Global("ysTalkedToRimon","GLOBAL",1)
    Global("ysCreateAkil","GLOBAL",1)~ THEN BEGIN 14
  SAY@4917
...
//---------------------------------------------------------
IF ~Global("ysTalkedToRimon","GLOBAL",1)
    Global("ysCreateAkil","GLOBAL",1)~ THEN BEGIN 15
	SAY @4919
...
//---------------------------------------------------------
IF ~Global("ysTalkedToRimon","GLOBAL",1)
    Global("ysCreateAkil","GLOBAL",1)~ THEN BEGIN 16
	SAY @4920
	IF~~THEN

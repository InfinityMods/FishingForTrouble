...
//---------------------------------------------------------
IF ~Global("ys_TalkedToDungeonGuard","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @1253
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToDungeonGuard","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @1256
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToDungeonGuard","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @1259
...
//---------------------------------------------------------
//Start fight
IF ~Global("ys_TalkedToDungeonGuard","GLOBAL",0)~ THEN BEGIN BLK4
	SAY @1264
	IF~~THEN

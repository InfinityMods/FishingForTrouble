...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~THEN BEGIN 6
  SAY @2455
  IF ~~ THEN REPLY @2456 GOTO 9
END

//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 7
  SAY @2457
  IF ~~ THEN
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 8
  SAY @2458
  IF ~~ THEN REPLY @2456 GOTO 9
END
...
//----------------------------
//Fedex starts
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 9
  SAY @2459
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 10
  SAY @2462
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 11
  SAY @2464
  IF ~~ THEN
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 12
  SAY @2465
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 13
  SAY @2468
      =@2469
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 14
  SAY @2471
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 15
  SAY @2475
  IF ~~ THEN REPLY @2476 GOTO 115
END

//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 115
  SAY @2477
  IF ~~ THEN
...
//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 16
  SAY @2478
  IF ~~ THEN REPLY @2479 GOTO 17
END

//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 17
  SAY @2480
  IF ~~ THEN REPLY @2481 GOTO 18
END

//----------------------------
IF ~Global("ys_talkedToEP","GLOBAL",0)~ THEN BEGIN 18
  SAY @2482
  IF ~~ THEN
  DO~SetGlobal("ys_talkedToEP","GLOBAL",2)
     AddJournalEntry(@59,QUEST)
...
IF ~Global("ys_talkedToEP","GLOBAL",2)
		PartyHasItem("ysepring")
    Global("ys_AnnoyedEP","GLOBAL",1)~ THEN BEGIN 201
  SAY @2487
  IF ~~ THEN REPLY @2488 SOLVED_JOURNAL @60
  DO~SetGlobal("ys_talkedToEP","GLOBAL",4)
    GivePartyGold(100)
...
IF ~Global("ys_talkedToEP","GLOBAL",2)
		PartyHasItem("ysepring")
    Global("ys_AnnoyedEP","GLOBAL",2)~ THEN BEGIN 301
  SAY @2491
...
//----------------------------
// Working for Bohdi
IF ~Global("ys_talkedToEP","GLOBAL",0)
		Global("WorkingForBodhi","GLOBAL",1)~ THEN BEGIN 160
  SAY @2493
  IF ~~ THEN
	  DO~SetGlobal("ys_talkedToEP","GLOBAL",1)~
  EXIT

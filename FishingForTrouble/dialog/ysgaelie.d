...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @1303
...
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK100
	SAY @1306
	IF~~THEN
    DO
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @1307
	IF~~THEN REPLY @1308 GOTO BLK3
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @1309
	IF~~THEN REPLY @1310 GOTO BLK4
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK4
	SAY @1311
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK5
	SAY @1314
	IF~~THEN REPLY @1315
    DO
      ~TakePartyItemNum("MISC07",5)~
    GOTO BLK7
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK6
	SAY @1316
	IF~~THEN REPLY @1317
    DO
      ~TakePartyItemNum("MISC07",2)~
    GOTO BLK7
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK7
	SAY @1318
	IF~~THEN REPLY @1319 GOTO BLK8
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK8
	SAY @1320
	IF~~THEN REPLY @1321 GOTO BLK9
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK9
	SAY @1322
  IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK10
  SAY @1325
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK11
	SAY @1328
	IF~~THEN
    DO
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK12
	SAY @1329
	IF~~THEN REPLY @1330 GOTO BLK114
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK114
	SAY @1331
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK13
	SAY @1334
	IF~~THEN
    DO
      ~SetGlobal("dai_TalkedToGaelie","GLOBAL",1)
      SetGlobal("dai_TalkedToCeinwen","GLOBAL",3)~
  EXIT
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToGaelie","GLOBAL",0)~ THEN BEGIN BLK14
	SAY @1335
  IF~~THEN
    DO
...
//---------------------------------------------------------
IF ~Global("ys_FoundKalun","GLOBAL",1)
    Global("ys_TalkedToGaelie","GLOBAL",1)~ THEN BEGIN BLK21
	SAY @1339
...
//---------------------------------------------------------
IF ~Global("ys_KalunIsDead","GLOBAL",1)~ THEN BEGIN BLK60
	SAY @1344
...
//---------------------------------------------------------
IF ~Global("ys_KalunIsDead","GLOBAL",1)~ THEN BEGIN BLK70
	SAY @1345

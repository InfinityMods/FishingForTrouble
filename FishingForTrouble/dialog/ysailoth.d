...
//---------------------------------------------------------
IF ~Global("ys_FoundWizard","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @1622
...
//---------------------------------------------------------
IF ~Global("ys_FoundWizard","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @1625
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK5
	SAY @1627
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK6
	SAY @1629
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK7
	SAY @1631
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK8
	SAY @1633
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK9
	SAY @1635
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK101
	SAY @1637
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK10
	SAY @1639
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK11
	SAY @1642
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK12
	SAY @1644
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK13
	SAY @1646
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK114
	SAY @1648
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK14
	SAY @1650
	IF~~THEN REPLY @1647 GOTO BLK15
END
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK116
	SAY @1653
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK16
	SAY @1655
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK17
	SAY @1657
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK20
	SAY @1660
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK21
	SAY @1662
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToAiloth","GLOBAL",0)
		Global("ys_FoundWizard","GLOBAL",1)~ THEN BEGIN BLK18
	SAY @1664
	IF~!InParty("Jaheira")~THEN

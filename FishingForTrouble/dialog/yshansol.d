...
//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 1
	SAY @2853
	IF~~THEN REPLY @2854 GOTO 2
END

//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 2
	SAY @2855
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 3
	SAY @2857
	IF~~THEN REPLY @2858 GOTO 4
END

//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 4
	SAY @2859
	IF~~THEN REPLY @2860 GOTO 5
END

//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 5
	SAY @2861
	IF~~THEN REPLY @2862 GOTO 6
END

//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 6
	SAY @2863
...
//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 7
	SAY @2866
...
//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 80
	SAY @2869
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",2)~ THEN BEGIN 8
	SAY @2870
...
IF ~Global("ys_FindColver","GLOBAL",3)~ THEN BEGIN 10
	SAY @2874
	IF~~THEN REPLY@2875EXIT
	IF~PartyGoldGT(499)~THEN REPLY @2872
	DO~TakePartyGold(500)
  SetGlobal("ys_FindColver","GLOBAL",4)~
  GOTO 11
	IF~~THEN REPLY@2876GOTO 100
END


//---------------------------------------------------------
IF ~Global("ys_FindColver","GLOBAL",4)~ THEN BEGIN 11
	SAY @2877
	IF~~THEN REPLY @2878

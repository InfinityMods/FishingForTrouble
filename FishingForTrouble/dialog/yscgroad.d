...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK1
	SAY @1454
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK2
	SAY @1456
...
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK3
	SAY @1458
	IF~~THEN
		DO ~OpenDoor("DOOR04")
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK10
	SAY @1459
	IF~~THEN
	...
	IF~~THEN
		REPLY @1461 GOTO BLK4
END

//---------------------------------------------------------
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK4
	SAY @1462
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK5
	SAY @1465
...
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK7
	SAY @1468
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ys_TalkedToTentGuard","GLOBAL",0)
		Global("ys_BlockPath","GLOBAL",0)~ THEN BEGIN BLK8
	SAY @1469
	IF~~THEN
		DO ~SetGlobal("ys_TalkedToTentGuard","GLOBAL",1)
				CloseDoor("DOOR04")~

...
//---------------------------------------------------------
//---------------------------------------------------------
IF ~Global("ysTalkedToAiesha","GLOBAL",2)~ THEN BEGIN 25
	SAY @4577
...
//---------------------------------------------------------
//---------------------------------------------------------
IF ~Global("ysTalkedToAiesha","GLOBAL",3)~ THEN BEGIN 30
	SAY @4588
	IF ~PartyHasItem("yssfrb") Global("ysCaveBlocked","GLOBAL",3)~ THEN 
	  DO ~TakePartyItem("yssfrb")~
    REPLY @4589 GOTO 32
	IF ~PartyHasItem("yssfrb") Global("ysCaveBlocked","GLOBAL",2)~ THEN 
	  DO ~TakePartyItem("yssfrb")~
    REPLY @4589 GOTO 33
	IF ~!PartyHasItem("yssfrb")~ THEN REPLY @4563 EXIT
END

...
//---------------------------------------------------------
IF ~Global("ysblgrd","GLOBAL",1)~ THEN BEGIN 1
  SAY@2669
	IF~~THEN
...
//---------------------------------------------------------
IF ~Global("ysblgrd","GLOBAL",1)~ THEN BEGIN 2
  SAY@2670
	IF~~THEN REPLY @2671
		DO~SetGlobal("ysblgrd","GLOBAL",2)~
	EXIT
...
//---------------------------------------------------------
IF ~Global("ysblgrd","GLOBAL",3)~ THEN BEGIN 3
  SAY@2672
	IF~~THEN
		DO~SetGlobal("ysblgrd","GLOBAL",2)~
	EXIT
...
//---------------------------------------------------------
IF ~Global("ysblgrd","GLOBAL",3)~ THEN BEGIN 4
  SAY@2673
	IF~~THEN
		DO~SetGlobal("ysblgrd","GLOBAL",2)~
	EXIT
